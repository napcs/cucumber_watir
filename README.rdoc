...
Stories always have a feature and a value
...
You can run a specific story with 
  ...
  cucumber $ rake features FEATURE=features/twitter.feature               
...
Place your steps in <tt>step_definitions/</tt>. The filename should be suffixed with <tt>_steps.rb</tt>.
=== Displaying steps
